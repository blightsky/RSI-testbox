...
declare class Decimal {
    ...
    static eq(value: DecimalValue, other: DecimalValue): boolean;
    static equals(value: DecimalValue, other: DecimalValue): boolean;
    static neq(value: DecimalValue, other: DecimalValue): boolean;
    static notEquals(value: DecimalValue, other: DecimalValue): boolean;
    static lt(value: DecimalValue, other: DecimalValue): boolean;
    static lte(value: DecimalValue, other: DecimalValue): boolean;
    static gt(value: DecimalValue, other: DecimalValue): boolean;
    static gte(value: DecimalValue, other: DecimalValue): boolean;
